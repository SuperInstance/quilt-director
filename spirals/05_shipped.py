"""
spiral 05: journal what shipped.

quilt-trace v0.1.0 — the organism's eyes — landed. 22 tests pass.
Composed 20 receipts across 4 substrates into organism.html.
"""
import os
from datetime import datetime

journal_dir = os.path.join(os.path.dirname(__file__) or ".", "..", "journal")
journal_path = os.path.join(journal_dir, "05-shipped-quilt-trace.md")

content = f"""# Spiral 05 — quilt-trace shipped
